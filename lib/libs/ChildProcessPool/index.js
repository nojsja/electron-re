...
var _require4 = require('../consts'),
    UPDATE_CONNECTIONS_SIGNAL = _require4.UPDATE_CONNECTIONS_SIGNAL;
...
var ChildProcessPool = /*#__PURE__*/function (_EventEmitter) {
  ...
  function ChildProcessPool(_ref) {
    ...
    _this.initEvents = function () {
      ...
      _this.connectionsTimer = setInterval(function () {
        EventCenter.emit("process-manager:".concat(UPDATE_CONNECTIONS_SIGNAL), _this.connectionsMap);
      }, 1e3); // message from forked process
    ...
    _this.onForkedCreate = function (forked) {
      ...
      EventCenter.emit('process-manager:listen', pidsValue, 'node', _this.forkedPath);
    };
    ...
    _this.connectionsMap = {};
    _this.forked = [];
    _this.connectionsTimer = null;
    _this.forkedMap = {};
  ...
  return (0, _createClass2["default"])(ChildProcessPool);
}(EventEmitter);
