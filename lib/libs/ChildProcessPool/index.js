  ...
  function ChildProcessPool(_ref) {
    ...
    _this.getForkedFromPool = function () {
      ...
      if (!_this.pidMap.get(id)) {
        ...
        if (id !== 'default') _this.pidMap.set(id, forked.pid);
        if (_this.pidMap.keys.length === 1000) console.warn('ChildProcessPool: The count of pidMap is over than 1000, suggest to use unique id!');
      } else {
