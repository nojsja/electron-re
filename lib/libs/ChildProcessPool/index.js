...
var _require = require('../utils'),
    ...
    convertForkedToMap = _require.convertForkedToMap;
  ...
  function ChildProcessPool(_ref) {
    ...
    _this.initEvents = function () {
      _this.on('fork', function (pids) {
        _this.LB.setTargets(pids.map(function (p, i) {
          return {
            id: p.pid,
        ...
        _this.getForkedMap(_this.forked);
    ...
    _this.weights = new Array(max).fill().map(function (_, i) {
      return weights[i] !== undefined ? weights[i] : 1;
    });
    ...
    */
    ...
    value: function sendToAll(taskName, params) {
      ...
      return new Promise(function (resolve) {
        ...
        _this3.collaborationMap.set(id, []);

        if (_this3.forked.length) {
          // use process in pool
          _this3.forked.forEach(function (forked) {
            forked.send({
              action: taskName,
              params: params,
              id: id
