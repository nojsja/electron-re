...
var ProcessManager = /*#__PURE__*/function () {
  function ProcessManager() {
    ...
    this.ipcSignalsRecorder = function (params, e) {
      _this.processWindow.sendToWeb('process:catch-signal', params);
    };

    this.refreshProcessList = function () {
        ...
        if (_this.pidList.length) {
          pidusage(_this.pidList, function (err, records) {
            if (err) {
              ...
              _this.processWindow.sendToWeb('process:update-list', {
                records: records,
                types: _this.typeMap
              });
            }
    ...
    this.pid = null;
    this.typeMap = (0, _defineProperty2["default"])({}, process.pid, {
      type: 'main',
      url: ''
    });
    this.status = 'pending';
  ...
  (0, _createClass2["default"])(ProcessManager, [{
                    ...
                    return _regenerator["default"].wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            _context.next = 2;
                            return _this2.refreshProcessList();
    ...
    value: function stdout(pid, data) {
      ...
      if (this.processWindow) {
        if (!this.callSymbol) {
          ...
          setTimeout(function () {
            _this3.processWindow.sendToWeb('process:stdout', _this3.logs);
    ...
    value: function listen(pids) {
      ...
      pids.forEach(function (pid) {
        ...
        _this5.typeMap[pid] = _this5.typeMap[pid] || {};
        _this5.typeMap[pid].type = mark;
        _this5.typeMap[pid].url = url;
      });
    }
    ...
    value: function openWindow() {
      ...
      app.whenReady().then(function () {
        _this6.processWindow = Object.assign(new BrowserWindow({
          show: false,
          width: 600,
          height: 400,
          ...
          sendToWeb: function sendToWeb(action, data) {
            if (!_this6.processWindow.isDestroyed()) _this6.processWindow.webContents.send(action, data);
          }
        });
        ...
        _this6.processWindow.once('ready-to-show', function () {
          ...
          _this6.startTimer(conf.uiRefreshInterval);
          ...
          ipcMain.on('process:catch-signal', function (event, args) {
            return _this6.ipcSignalsRecorder(args || event);
          });
        });
