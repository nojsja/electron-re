...
var DynamicThreadPool = /*#__PURE__*/function (_ThreadPool) {
  ...
  function DynamicThreadPool() {
    ...
    _this.exec = function (payload) {
      ...
      DynamicThreadPool.paramsCheckForExec(Object.assign({}, options, (0, _assertThisInitialized2["default"])(_this)));
  ...
  (0, _createClass2["default"])(DynamicThreadPool, [{
    ...
    value: function queue(payload) {
      ...
      return (0, _get2["default"])((0, _getPrototypeOf2["default"])(DynamicThreadPool.prototype), "queue", this).call(this, payload, options);
    }
    /**
