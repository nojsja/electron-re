...
var _excluded = ["taskId", "threadId", "code"],
    _excluded2 = ["execPath", "execFunction", "transferList"];
...
var ThreadPool = /*#__PURE__*/function (_EventEmitter) {
   ...
   *  ...
   */
  function ThreadPool(execContent) {
    var _this;
  ...
  (0, _createClass2["default"])(ThreadPool, [{
    ...
    value: function fillPoolWithIdleThreads() {
      ...
      var threads = new Array(countToFill).fill(0).map(function () {
        var thread = ThreadPool.generateNewThread(_this3.execContent, _this3.options.type, _this3.threadOptions);
    ...
    value: function consumeTask(task) {
      ...
      if (!this.isFull) {
        var thread = ThreadPool.generateNewThread(this.execContent, this.options.type, this.threadOptions);
    ...
    value: function exec(payload) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var task = ThreadPool.generateNewTask(payload, _objectSpread(_objectSpread({}, options), {}, {
        ...
        if (!_this4.isFull) {
          var thread = ThreadPool.generateNewThread(_this4.execContent, _this4.options.type, _this4.threadOptions);
...
ThreadPool.maxTaskRetry = 5;
ThreadPool.minTaskLoopTime = 100;
