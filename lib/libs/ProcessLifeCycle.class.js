  ...
  function ProcessLifeCycle(options) {
    ...
    _this.taskLoop = function () {
      ...
      _this.timer = setInterval(function () {
        ...
        activities.entries(function (_ref) {
    ...
    var _options$expect = options.expect,
        expect = _options$expect === void 0 ? 600e3 : _options$expect,
        _options$internal = options.internal,
        internal = _options$internal === void 0 ? 30e3 : _options$internal;
    _this.timer = null;
