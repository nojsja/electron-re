...
var BrowserService = function () {
  ...
  function BrowserService(name, _path) {
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { dev: false };
    ...
    value: function watchService(isEnvDev) {
      ...
      if (isEnvDev) {
        ...
        this.callbacks.push(function () {
          return _this._super.webContents.send('get-watching-files', { pid: pid });
        });
        ...
        FileWatcher.watch(this.exec, function () {
          debouncer(_this._super.webContents.reload.bind(_this._super.webContents), 1e3, false, null);
        });
      }
    }
